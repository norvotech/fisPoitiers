...
define('DNS_2', 'mysql:host='.$PARAM_hote.';dbname='.$PARAM_nom_bd2);
...
define('PROFIL', ' (nom, prenom, pseudo, email, password) VALUES (:nom, :prenom, :pseudo, :email, :pass)');
define('IDMEMBRE', ' WHERE id_membre=:id');
define('LOGIN', ' WHERE pseudo=:login');
define('ACTIVMEMBRE', ' SET activation=:activer');
define('MAJPROFIL', ' SET email=:email, tel=:tel, adresse=:adresse, cp=:cp, ville=:ville, genre=:genre, naissance=:naissance, nom=:nom, prenom=:prenom, facebook=:facebook, twitter=:twitter, site=:site, description=:description, mailing=:mailing WHERE id=:id');
